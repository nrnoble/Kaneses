      ...
      <!-- <div class="row"> -->
		...
		<form class="form-horizontal" id="volunteer_form" action="" method="post" role="form">
				...
				<div class="form-group">
				  <label class="col-sm-2 control-label" for="fname">First Name:
				...
				<div class="form-group">
				  <label class="col-sm-2 control-label" for="lname">Last Name:
			   ...
			   <div class="form-group">
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-5">
					<input type="phonenumber" class="col-sm-5 form-control" name="phonenumber" id="phonenumber"
					<?php
						if ($errors || $missing) {
			...
			<div class="form-group">
			   <label class="col-sm-2 control-label">I have committed theft, fraud, assault, or a crime against children.</label>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Volunteer Activities Offered:</label>
				<div class="col-sm-5">
					<div class="checkbox">
			...
			<fieldset>
				<legend>Questions</legend>
						...
						<label for="availability_text">If No to the above question, what is your availability?</label><br>
					    ...
					    <textarea rows="5" cols = "40" name="whyVolunteer" id="whyVolunteer"><?php if ($errors || $missing) { echo htmlentities($whyVolunteer); }?></textarea><br>
            </fieldset>
