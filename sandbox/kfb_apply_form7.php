...
<?php
	...
	//$cnxn = @mysqli_connect("127.0.0.1", "kaneses_kfb", "Ru4real2016", "kaneses_kfb") or die("Error connecting to database: " .mysqli_connect_error());
...
// Define the query
$sql = "INSERT INTO volunteers (first_name, last_name, email, phone)
		  VALUES
...
echo "<h3>New volunteer added!</h3>";
      ...
      <div class="row">
		...
		<form id="volunteer_form" action= "" method="post">
			...
			<fieldset class="criminal">
						...
						<label id="lift40"><input type="radio" value="no" name="lift" id="lift"
						<?php
						if ($lift == "no") {
						    echo 'checked="checked"';
						}
