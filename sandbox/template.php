	...
	<body class="no-trans   ">
		...
		<div class="page-wrapper">
			...
			<div class="header-container">
				...
				<!-- ================ -->
				<div class="brand"><h1>Kent Food Bank &amp; Emergency Services</h1></div>
				<div class="address-bar"><h3>Serving low-income residents of the Kent School District</h3></div>
							...
							<div class="col-md-3">
								...
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href="index.html"><img id="logo_img" src="images/kfblogo2.png" alt="KFB logo"></a>
									</div>
			...
			<div class="breadcrumb-container">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li class="active">Page Affix Sidebar</li>
					</ol>
				</div>
			</div>
			-->
							...
							<div class="sidebar">
								<nav class="affix-menu scrollspy">
									<ul class="smooth-scroll nav nav-pills nav-stacked">
										<li class="active"><a href="#header-1">Location</a></li>
										<li><a href="#header-2">Contact</a></li>
										<li><a href="#header-3">About US</a></li>
										<li><a href="#header-4">Services</a></li>
										<li><a href="#header-5">Donate</a></li>
										<!-- Neal
										<li><a href="#header-6">Header - 6</a></li>
										<li><a href="#header-7">Header - 7</a></li>
										<li><a href="#header-8">Header - 8</a></li>
